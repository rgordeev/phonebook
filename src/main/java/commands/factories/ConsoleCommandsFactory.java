...
public class ConsoleCommandsFactory extends CommandFacroryBase
{
    ...
    private ConsoleCommandsFactory()
    {
        ...
        register(CommandDelete.COMMNAME, injector.getInstance(CommandDeleteBuilder.class));
        register(CommandUpdate.COMMNAME, injector.getInstance(CommandUpdateBuilder.class));
    }
